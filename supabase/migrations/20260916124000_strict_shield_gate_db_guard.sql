-- ============================================================
-- Secondary Guardrail: process_incoming_marketing_message
-- Ensures no lead is auto-created in DB if metadata explicitly marks it as junk/unqualified
-- 2026-09-16
-- ============================================================
...
BEGIN
    ...
    IF v_lead_id IS NULL THEN
        ...
        -- Create new Prospecto lead with auto-detected source & product
        IF v_lead_id IS NULL THEN
            INSERT INTO leads (
                company_id,
                name,
