...
export default function Leads() {
    ...
    const openLeadDetail = async (lead: Lead) => {
        // Carga ligera: Muestra la data base de inmediato para UX fluida
        ...
        try {
            // Carga pesada en background (relaciones como cotizaciones)
            const fullLead = await leadsService.getLeadById(lead.id);
