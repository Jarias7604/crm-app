...
export default function ChatHub() {
    ...
    const handleSendPendingQuote = async () => {
        ...
        try {
            // 1. Send the visual Quote card
            const messageContent = `__QUOTE__ {"id": "${pendingQuote.id}", "total": ${pendingQuote.total_anual}, "client": "${pendingQuote.nombre_cliente}"}`;
            await chatService.sendMessage(selectedConv.id, messageContent);

            // 2. If PDF was generated, send it as a real file attachment automatically
            ...
            toast.success('¡Cotización y PDF enviados!');
        } catch (error) {
