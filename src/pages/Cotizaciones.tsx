...
export default function Cotizaciones() {
    ...
    if (loading) {
        return (
            <>
                {/* Mobile loading → skeleton cards inside the mobile view */}
                <div className="sm:hidden">
                    <CotizacionesMobileView
                        cotizaciones={[]}
                        stats={{ total: 0, enviadas: 0, aceptadas: 0, valor_total: 0, valor_aceptadas: 0 }}
                        loading={true}
    ...
    return (
        <>
            ...
            <div className="sm:hidden">
                <CotizacionesMobileView
                    cotizaciones={sortedCotizaciones}
                    stats={stats}
                    loading={loading}
                    onDelete={handleDelete}
                />
