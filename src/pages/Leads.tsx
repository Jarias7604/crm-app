    ...
    const PriorityDropdown = () => (
        <div className="relative" ref={priorityFilterRef}>
            <button
                ...
                className="flex items-center space-x-2 bg-white border border-gray-100 text-[#4449AA] px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-gray-50 transition-all shadow-sm h-10 min-w-[180px] justify-between"
            >
            ...
            {isPriorityFilterOpen && (
                <div className="absolute left-0 mt-2 w-64 bg-white rounded-2xl shadow-xl border border-gray-50 z-50 py-2 animate-in fade-in slide-in-from-top-2">
                    <button
                        ...
                        className={`w-full text-left px-4 py-3 text-xs font-black uppercase tracking-widest transition-colors flex items-center justify-between ${priorityFilter === 'all'
                    ...
                    {(Object.entries(PRIORITY_CONFIG) as [LeadPriority, { label: string, icon: string, color: string, textColor: string }][]).map(([key, config]) => (
                        <button
                            ...
                            className={`w-full text-left px-4 py-3 text-xs font-black uppercase tracking-widest transition-colors flex items-center justify-between ${priorityFilter === key
                                ? 'bg-blue-50 text-[#007BFF]'
                                : 'text-gray-500 hover:bg-gray-50'
                                }`}
                        >
    ...
    const StatusDropdown = () => (
        <div className="relative" ref={statusFilterRef}>
            <button
                ...
                className={`flex items-center space-x-2 bg-white border px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-gray-50 transition-all shadow-sm h-10 min-w-[170px] justify-between ${statusFilter !== 'all' ? 'border-blue-300 text-blue-600' : 'border-gray-100 text-[#4449AA]'}`}
            >
                <div className="flex items-center gap-2">
    ...
    const LossReasonDropdown = () => (
        <div className="relative" ref={lossReasonFilterRef}>
            <button
                ...
                className={`flex items-center space-x-2 bg-white border px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-gray-50 transition-all shadow-sm h-10 min-w-[200px] justify-between ${lossReasonFilter !== 'all' ? 'border-amber-300 text-amber-600' : 'border-gray-100 text-[#4449AA]'}`}
            >
                <div className="flex items-center gap-2">
            ...
            {isLossReasonFilterOpen && (
                <div className="absolute left-0 mt-2 w-64 bg-white rounded-2xl shadow-xl border border-gray-50 z-50 py-2 animate-in fade-in slide-in-from-top-2">
                    <button
                        ...
                        className={`w-full text-left px-4 py-3 text-xs font-black uppercase tracking-widest transition-colors ${lossReasonFilter === 'all' ? 'bg-amber-50 text-amber-600' : 'text-gray-500 hover:bg-gray-50'}`}
                    >
                        Todos los Motivos
                    </button>
                    <div className="border-t border-gray-100 my-1" />
                    {lossReasons.map(reason => (
                        <button
                            ...
                            className={`w-full text-left px-4 py-3 text-xs font-black uppercase tracking-widest transition-colors ${lossReasonFilter === reason.id ? 'bg-amber-50 text-amber-600' : 'text-gray-500 hover:bg-gray-50'}`}
                        >
                            {reason.reason}
                        </button>
                    ))}
    ...
    const LossStageDropdown = () => (
        <div className="relative" ref={lostAtStageFilterRef}>
            <button
                ...
                className={`flex items-center space-x-2 bg-white border px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-gray-50 transition-all shadow-sm h-10 min-w-[180px] justify-between ${lostAtStageFilter !== 'all' ? 'border-rose-300 text-rose-600' : 'border-gray-100 text-[#4449AA]'}`}
            >
                <div className="flex items-center gap-2">
                    <Filter className="h-3.5 w-3.5" />
            ...
            {isLostAtStageFilterOpen && (
                <div className="absolute left-0 mt-2 w-64 bg-white rounded-2xl shadow-xl border border-gray-50 z-50 py-2 animate-in fade-in slide-in-from-top-2">
                    <button
                        ...
                        className={`w-full text-left px-4 py-3 text-xs font-black uppercase tracking-widest transition-colors ${lostAtStageFilter === 'all' ? 'bg-rose-50 text-rose-600' : 'text-gray-500 hover:bg-gray-50'}`}
                    >
                        Todas las Etapas
                    </button>
                    <div className="border-t border-gray-100 my-1" />
                    {(Object.entries(STATUS_CONFIG) as [LeadStatus, any][])
                        ...
                        .map(([key, config]) => (
                            <button
                                ...
                                className={`w-full text-left px-4 py-3 text-xs font-black uppercase tracking-widest transition-colors flex items-center gap-2 ${lostAtStageFilter === key ? 'bg-rose-50 text-rose-600' : 'text-gray-500 hover:bg-gray-50'}`}
                            >
                                <span>{config.icon}</span>
                                {config.label}
                            </button>
            ...
            <div className="w-full max-w-[1500px] mx-auto pb-6 space-y-8">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div className="w-full md:w-auto">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mt-2">
                            ...
                            <div className="hidden md:flex items-center gap-3 flex-wrap">
                                <span className="text-[10px] font-black text-gray-400 uppercase tracking-[0.25em]">Filtros Rápidos</span>
                                <StatusDropdown />
                                <PriorityDropdown />
                                ...
                                <div className="relative" ref={assignedFilterRef}>
                                    <button
                                        ...
                                        className={`flex items-center space-x-2 bg-white border px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-gray-50 transition-all shadow-sm h-10 min-w-[160px] justify-between ${assignedFilter !== 'all' ? 'border-indigo-300 text-indigo-600' : 'border-gray-100 text-[#4449AA]'}`}
                                    >
                                        <div className="flex items-center gap-2">
                                            <User className="h-3.5 w-3.5" />
                                            <span>{assignedFilter === 'all' ? 'Todos' : assignedFilter === 'unassigned' ? 'Sin' : teamMembers.find(m => m.id === assignedFilter)?.full_name?.split(' ')[0] || 'Agente'}</span>
                                        </div>
                                    ...
                                    {isAssignedFilterOpen && (
                                        <div className="absolute left-0 mt-2 w-64 bg-white rounded-2xl shadow-xl border border-gray-50 z-50 py-2">
                                            <button
                                                onClick={() => { setAssignedFilter('all'); setIsAssignedFilterOpen(false); }}
                                                className={`w-full text-left px-4 py-3 text-xs font-black uppercase tracking-widest transition-colors ${assignedFilter === 'all' ? 'bg-blue-50 text-[#007BFF]' : 'text-gray-500 hover:bg-gray-50'}`}
                                            >
                                                Todos
                                            </button>
                                            <div className="border-t border-gray-100 my-1" />
                                            {teamMembers.map(member => (
                                                <button
                                                    ...
                                                    className={`w-full text-left px-4 py-3 text-xs font-black uppercase tracking-widest flex items-center gap-2 ${assignedFilter === member.id ? 'bg-blue-50 text-[#007BFF]' : 'text-gray-500 hover:bg-gray-50'}`}
                                                >
                    ...
                    {(filteredLeadId || filteredLeadIds || statusFilter !== 'all' || priorityFilter !== 'all' || assignedFilter !== 'all' || sourceFilter !== 'all' || lossReasonFilter !== 'all' || lostAtStageFilter !== 'all' || startDateFilter || endDateFilter) && (
                        <div className="flex items-center gap-2 animate-in fade-in slide-in-from-top-2 w-full">
                            <div className="bg-indigo-50/50 text-indigo-700 px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-[0.1em] flex items-center gap-2 border border-indigo-100/50 flex-wrap">
                    ...
                    <div className="flex flex-wrap gap-2 w-full xl:w-auto">
                        ...
                        <Button
                            ...
                            className="flex-1 sm:flex-none justify-center h-10 bg-[#4449AA] hover:bg-[#383d8f] px-6 text-xs font-black uppercase tracking-widest text-white shadow-lg shadow-indigo-100 transition-all border-none"
                        >
