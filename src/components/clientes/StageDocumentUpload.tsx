...
import { Upload, File, Trash2, Download, CheckCircle2, Circle, Loader2, X, Save } from 'lucide-react';
                ...
                <div className="flex items-end gap-2">
                  ...
                  {!readOnly && (
                    <button
                      ...
                      className="p-2 rounded-xl bg-[#4449AA] text-white hover:bg-[#3338a0] disabled:opacity-40 disabled:cursor-not-allowed transition-all flex-shrink-0"
                    >
                      {savingText[dt.id] ? (
                        <Loader2 className="w-3.5 h-3.5 animate-spin" />
                      ) : (
