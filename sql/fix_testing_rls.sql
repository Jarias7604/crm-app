...
-- Proyecto: crm-app-testing (ubqscyfefgfbmndnypbp)
-- ================================================================

-- 1. Activar Row-Level Security en las 4 tablas reportadas
...
BEGIN
  ...
  EXCEPTION WHEN OTHERS THEN
    -- Si los roles de Supabase gestionados restringen event triggers, se maneja limpiamente
    NULL;
  END;
END $$;
