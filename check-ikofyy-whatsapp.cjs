...
const supabase = createClient(
    ...
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imlrb2Z5eXB4cGhycWtuY2ltc3p0Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0MzAzODE3OSwiZXhwIjoyMDU4NjE0MTc5fQ.Pd_nwvXH7JWt7PrxP4EWqp0A0MrFHqFmIANz1_yHjik'
);

async function checkIkofyy() {
    console.log('=== CHECKING IKOFYYPXPHRQKNNCIMSZT DATABASE ===\n');
...
checkIkofyy().catch(console.error);
